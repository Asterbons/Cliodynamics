...
# Load the CSV data_wages with correct separator and encoding
df = pd.read_csv('data_wages.csv', sep=';', encoding='utf-8')

# Select only the relevant columns
cols_to_keep = ['time', '1_variable_attribute_label', 'value_variable_label', 'value']
...
df_clean['value_variable_label'] = df_clean['value_variable_label'].apply(fix_encoding)
...
df_final = df_clean[df_clean['value_variable_label'].isin(categories)]
