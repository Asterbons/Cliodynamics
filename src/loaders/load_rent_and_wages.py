...
csv_data_rent_index = download_and_unzip(base_url, headers, payload_price_index)
...
if csv_data_rent_index:
    with open(DATA_RAW / "data_rent_index.csv", "w", encoding="utf-8") as f:
        f.write(csv_data_rent_index)
    print("Success: data_rent_index.csv updated.")