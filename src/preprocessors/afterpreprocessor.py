...
def main():
    ...
    try:
        master_df = pd.read_csv(DATA_PROCESSED / 'master_cliodynamics.csv')
    ...
    df_students = process_students(DATA_RAW / 'data_students_test.csv')
    ...
    # 6. Сохранение
    output_file = DATA_PROCESSED / 'master_cliodynamics_v2.csv'
