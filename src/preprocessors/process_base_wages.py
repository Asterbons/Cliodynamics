...
df_wages = process_wages(DATA_RAW / 'data_wages.csv')
df_prices = process_prices(DATA_RAW / 'data.csv')
...
master_df.to_csv(DATA_PROCESSED / 'master_cliodynamics.csv', index=False)